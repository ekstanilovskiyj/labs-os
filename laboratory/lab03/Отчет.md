...
Скачиваем пример отчета с github, подстраиваем отчет под себя.

![Как выглядит файл с markdown](image/01.png){ #fig:001 width=70% }

# Вывод

Мы научились оформлять отчеты с помощью языка Markdown